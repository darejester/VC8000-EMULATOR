...
SYNOPSIS
    ...
    bool FileAccess::GetNextLine( string &a_line )
        a_line	-> container for the next instruction line


DESCRIPTION

    This function attempts to get the next instruction line

RETURNS

        Returns true if there is another instruction line, false if not
*/
/**/
...
DESCRIPTION
    ...
    This function attempts to start the file reading from the beginning again.
